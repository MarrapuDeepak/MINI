...
def demo_gan():
    ...
    st.markdown("---")
    st.markdown("**Enter the description of the Bird:**")
    st.markdown("Hint : describe the bird features clearly")
    st.markdown("Example : A yellow bird with red crown, black short beak and long tail")
    st.markdown("---")

    #st.subheader("Enter the description of the bird : ")
    #st.write("Hint : describe the bird features clearly")
    ...
    if user_input:
        ...
        center_element(type="subheading", text="StackGAN synthesized bird")
        st.text("")
        center_element(
